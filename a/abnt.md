...
# NBR 6024:2012 Informação e documentação - Referências - Elaboração
...
A norma internacional para numeração de títulos, no contexto de trabalhos acadêmicos e publicações, é a ABNT NBR 6024, que estabelece as regras para numeração progressiva de seções e subseções. Essa norma detalha como atribuir números sequenciais aos títulos e subtítulos, seguindo uma estrutura hierárquica. 

# 2. Elaboração

A norma ABNT NBR 6024 especifica que a numeração progressiva deve ser utilizada em todos os níveis de seções e subseções de um trabalho. Isso significa que cada título e subtítulo deve receber um número que indique sua posição na estrutura do documento.
...
Além disso, a ABNT NBR 6024 orienta sobre a formatação da numeração, incluindo o uso de algarismos arábicos, pontos e espaços, para garantir a clareza e a organização do documento. 
...
FM2S Educação e Consultoria. Normas ABNT: como formatar trabalhos acadêmicos. Disponível em *https://www.fm2s.com.br/blog/normas-abnt#:~:text=Esta%20norma%20estabelece%20as%20regras%20para%20numera%C3%A7%C3%A3o%20progressiva%20das%20se%C3%A7%C3%B5es,e%20documenta%C3%A7%C3%A3o%20%2D%20Sum%C3%A1rio%20%2D%20Apresenta%C3%A7%C3%A3o*. Acessado em 14 de julho de 2025.
